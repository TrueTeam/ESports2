...
public class PostBean {
    ...
    public PostBean(String id, String content, String icon, String pic, String uid, String nickname, String head, String praises, String reviews, String create_time, String circle_title, String is_praise, String head_link) {
        this.id = id;
