 ...
 */
public class TopicMoreHelper {

    private static TopicMoreHelper helper;
    private Retrofit retrofit;
    private IGamesService service;
    private Gson gson;
    private TopicMoreHelper(){
        gson = new GsonBuilder()
                .serializeNulls()
                .create();
        retrofit = new Retrofit.Builder()
                .addConverterFactory(new TopicMoreFactory())
    ...
    public static synchronized TopicMoreHelper newInstance(){
        if (helper == null){
            helper = new TopicMoreHelper();
        }
        return helper;
    }
}
